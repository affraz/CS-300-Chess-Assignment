 ...
 * @author affraz
 */
public class Client extends javax.swing.JFrame implements ClientMethods{
            ...
            if( isLabelSelected ){
                ...
                if( board.boardArray[x][y].getColour() == board.turn ){
                    ...
                    if( currentPiece.validateMove( tmp ) ){
                        ...
                        try {
                            server.killRemote( currentPiece.getLocation(), tmp);
                            server.moveRemote( currentPiece.getLocation(), tmp );
                        }
                        catch (RemoteException ex) {
                            ex.printStackTrace();
                        }
    ...
    public static void main(String args[]) throws Exception{
        ...
        // Binding client object to registry with name 'clientStub'
        
        obj = new Client();
        ClientMethods clientStub = (ClientMethods) UnicastRemoteObject.exportObject(obj,0);
        String name = "clientStub";
        
        Registry reg = LocateRegistry.getRegistry();
        reg.rebind(name,clientStub);
        
        // Getting remote object of server
        Registry reg1 = LocateRegistry.getRegistry("localhost");
        
        String name1 = "serverStub";
        server = (ServerMethods) reg1.lookup(name1);
        
        //System.out.println("Got remote server object");
